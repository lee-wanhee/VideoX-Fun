#!/bin/bash
# ==============================================================================
# Experiment 3: Different Masking, Different Order, VAE Only
# - Random masking (different masks each batch)
# - Random order (different token order in parallel_extract_features each batch)
# - VAE only mode (no PSI semantic projection, only use VAE-encoded decoded frames)
#
# Usage: bash exp3_diff_mask_diff_order_vae_only.sh <host_address> <node_rank>
# Example: bash exp3_diff_mask_diff_order_vae_only.sh n12 0
# ==============================================================================
...
if [ -f ~/.wandb_api_key ]; then
    ...
    export WANDB_RUN_NAME="exp3_diff_mask_diff_order_vae_only"
...
echo "=============================================="
echo "Experiment 3: Different Masking, Different Order, VAE Only"
echo "=============================================="
