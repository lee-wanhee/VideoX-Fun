#!/bin/bash
# ==============================================================================
# Experiment 4: All Tokens Feature with Projection
...
# features for ALL 4 content tokens per patch, giving 4x more features
# and better decoded frames compared to the coarse-only extraction.
#
# Usage: bash exp4_all_tokens_with_projection.sh <host_address> <node_rank>
# Example: bash exp4_all_tokens_with_projection.sh n12 0
# ==============================================================================
...
if [ -f ~/.wandb_api_key ]; then
    ...
    export WANDB_RUN_NAME="exp4_all_tokens_with_proj"
...
export OUTPUT_DIR="/scratch/m000063/users/wanhee/VideoX-Fun/output_exp4_all_tokens_with_projection_${TIMESTAMP}"
...
echo "=============================================="
echo "Experiment 4: All Tokens Feature with Projection"
echo "=============================================="
