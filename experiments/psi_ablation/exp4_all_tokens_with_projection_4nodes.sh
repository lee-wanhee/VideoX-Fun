#!/bin/bash
# ==============================================================================
# Experiment 4 (4-node version): All Tokens Feature with Projection
...
#
# This is the 4-node version for fair comparison with exp6.
# Sparse control: only latent 0 and second_latent_idx get PSI info.
#
# Usage: bash exp4_all_tokens_with_projection_4nodes.sh <host_address> <node_rank>
# Example: bash exp4_all_tokens_with_projection_4nodes.sh n12 0
# ==============================================================================
...
if [ -f ~/.wandb_api_key ]; then
    ...
    export WANDB_RUN_NAME="exp4_all_tokens_with_proj_4nodes"
...
export OUTPUT_DIR="/scratch/m000063/users/wanhee/VideoX-Fun/output_exp4_all_tokens_4nodes_${TIMESTAMP}"
...
echo "=============================================="
echo "Experiment 4 (4-node): All Tokens Feature with Projection"
echo "=============================================="
...
echo "  - psi_temporal_propagation: False (SPARSE - only latent 0 and target)"
